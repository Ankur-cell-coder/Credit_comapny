...
const data = [
  {
    name:'Acme Corporation',id:'ABC123454',status:'Loreum ipsum',class:'Loreum ipsum',category:'Loreum ipsum',subcategory:'Loreum ipsum',date:'Loreum ipsum'
  },
  {
    name:'Acme Corporation',id:'ABC123454',status:'Loreum ipsum',class:'Loreum ipsum',category:'Loreum ipsum',subcategory:'Loreum ipsum',date:'Loreum ipsum'
  },
  ...
  return (
     ...
     <div className='uppersection'>
        ...
        <div className='inputsection'>
          <input placeholder='  Enter role of the company' className='valuesection'></input>
          <input placeholder='  Enter Order volume' className='valuesection'></input>
